...
| check | result |
|---|---|
| `pytest tests` on Python 3.13 | 2121 passed |
...
2121 tests, 98% statement coverage, offline by construction. Deduplication
...
2121 tests on Python 3.13, 98% statement coverage, no network access in any
test."
...
- 2121 tests pass on Python 3.13; on Python 3.9, 2097 pass and 4 skip because
