...
| check | result |
|---|---|
| `pytest tests` on Python 3.13 | 2116 passed |
...
2116 tests, 98% statement coverage, offline by construction. Deduplication
...
2116 tests on Python 3.13, 98% statement coverage, no network access in any
test."
...
- 2116 tests pass on Python 3.13; on Python 3.9, 2097 pass and 3 skip because
